...
def get_page_number(article_title, listing_url):
    try:
        ...
        title_div = listing_bsoup.find_all(text=re.compile(article_title))
        page = title_div[0].parent.select('.pages')
        page = page[0].getText()
        return page
...
while min_article_url_no <= max_article_url_no:
    ...
    if response.status_code == 200:
        ...
        pn = get_page_number(
            title, "https://www.ajol.info/index.php/ahs/issue/view/19602")
